...
extern void FUN_0206ebdc(u32 handle);
extern void FUN_0206ed20(u32 handle);
extern void FUN_0206ea88(u32 handle);
extern void FUN_020027a4(void* objectPtr);

/**
 * FUN_02002948 - Resource object cleanup/destructor
 * 
 ...
 * 4. Calling additional cleanup via FUN_020027a4
 * 
 * The three overlay functions called appear to be:
 * - FUN_0206ebdc: Some kind of release/stop operation
 * - FUN_0206ed20: Another release/cleanup operation  
 * - FUN_0206ea88: Final cleanup/free operation
 * 
 ...
 */
void FUN_02002948(void* objectPtr) {
    ...
    FUN_0206ebdc(primaryHandle);  // Step 1: Stop/pause
    FUN_0206ed20(primaryHandle);  // Step 2: Unload/release
    FUN_0206ea88(primaryHandle);  // Step 3: Free/destroy
    ...
    if (hasSecondary == 1) {
        ...
        FUN_0206ebdc(secondaryHandle);
        FUN_0206ed20(secondaryHandle);
        FUN_0206ea88(secondaryHandle);
    }
