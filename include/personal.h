 ...
 *
 * Stores the data of a Pokémon, this is the data layout of the files in the narc "a/0/1/6"
 */
...
typedef enum PersonalField {
	...
	PERSONAL_GROUNDED_SPRITE = 0x10, // evYield (0x1000) [Used by Diglett and Dugtrio]
	...
	PERSONAL_FORM_DATA_OFFSET = 0x1E, // Offset after the last data file where the form files are located (narcs a/0/0/16, a/0/0/18, a/0/0/19)
	PERSONAL_FORM_SPRITE_OFFSET = 0x1F, // Offset after the sprite files where the form sprite files are located (narc a/0/0/4)
