...
typedef struct ALIGNED(4) BoxPokemon {
  u32 pid;
  u16 sanityFlags;
  u16 checksum;
...
typedef struct ALIGNED(4) BoxPokemonBlock0 {
  u16 species;
  u16 heldItem;
...
typedef struct ALIGNED(4) BoxPokemonBlock1 {
  u16 moves[4];
  u8 movePPs[4];
  u8 movePPUpStages[4];
  u32 ivBits;
...
typedef struct ALIGNED(8) BoxPokemonBlock2 {
  wchar_t nickname[11];
  u8 field_16;
  u8 originGame;
  u64 ribbons3;
...
typedef struct ALIGNED(16) BoxPokemonBlock3 {
  u16 OTName[8];
  u8 hatchDateYear;
  u8 hatchDateMonth;
  u8 hatchDateDay;
