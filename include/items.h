 ...
 *
 * Stores the data of an item that has properties when used by the player in
 * battle.
 */
 ...
 *
 * Stores the data of an item, this is the data layout of the files in the narc
 * "a/0/2/4"
 */
typedef struct ALIGNED(4) ItemData {
  u16 price;
  u8 heldEffect;
  u8 heldParam;
 ...
 *
 * Creates a registrable item value merging the RegistrableID and the Item
 * index.
 */
