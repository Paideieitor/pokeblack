 ...
 *
 * Stores the data of an trainer, this is the data layout of the files in the narc "a/0/9/2".
 */
 ...
 *
 * Defines the values that can be set to assign an avility to a trainers Pokémon.
 */
 ...
 *
 * Stores the default data of an trainers Pokémon, this is the data layout of the
 * files in the narc "a/0/9/3".
 * The file is comprised of consecutive members, the amount is specified in the
 * trainer data.
 * Depending on the trainer type this structure can have additional information.
 */
