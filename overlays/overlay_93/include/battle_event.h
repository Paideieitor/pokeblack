...
typedef enum BattleEventItemType {
  EVENTITEM_MOVE = 0x0,
  EVENTITEM_POS = 0x1,
  EVENTITEM_SIDE = 0x2,
  EVENTITEM_FIELD = 0x3,
...
typedef bool32 (*BattleEventSkipCheckHandler)(void *skipHandler, u32 *work,
                                              BattleEventItemType factorType,
                                              u32 eventType, u16 subID,
                                              u8 battleSlot);

struct BattleEventHandlerTableEntry;

typedef struct ALIGNED(4) BattleEventItem {
...
typedef struct BattleEventHandlerTableEntry {
  BattleEventType type;
  BattleEventHandler handler;
} BattleEventHandlerTableEntry;
